...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('board_board', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
    def backwards(self, orm):

        # Changing field 'Board.name'
        db.alter_column('board_board', 'name', self.gf('django.db.models.fields.SlugField')(max_length=50))
    models = {
        'auth.group': {
