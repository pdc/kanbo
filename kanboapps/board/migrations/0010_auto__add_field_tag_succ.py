...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.succ'
        db.add_column('board_tag', 'succ',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Tag'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Tag.succ'
        db.delete_column('board_tag', 'succ_id')
