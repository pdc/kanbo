...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Board.slug'
        db.delete_column('board_board', 'slug')

        # Adding field 'Board.name'
        db.add_column('board_board', 'name',
                      self.gf('django.db.models.fields.SlugField')(default='board', max_length=50),
                      keep_default=False)

        # Adding unique constraint on 'Board', fields ['owner', 'name']
        db.create_unique('board_board', ['owner_id', 'name'])

    def backwards(self, orm):
        # Removing unique constraint on 'Board', fields ['owner', 'name']
        db.delete_unique('board_board', ['owner_id', 'name'])

        # Adding field 'Board.slug'
        db.add_column('board_board', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='board', max_length=50),
                      keep_default=False)

        # Deleting field 'Board.name'
        db.delete_column('board_board', 'name')
