...
urlpatterns = patterns('kanboapps.board.views',
    ...
    url(r'^(?P<board_id>\d+)$', 'card_list', name='card-list'),
    url(r'^(?P<board_id>\d+)/grids/(?P<col_name>[\w-]+)$', 'card_grid', name='card-grid'),
    url(r'^(?P<board_id>\d+)/rearrangement$', 'rearrangement', name='rearrangement'),
    url(r'^(?P<board_id>\d+)/grids/(?P<col_name>[\w-]+)/new$', 'new_card', name='new-card'),
    url(r'^(?P<board_id>\d+)/grids/(?P<col_name>[\w-]+)/create$', 'create_card', name='create-card'),
